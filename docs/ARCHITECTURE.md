...
> 更细的模块级接口清单见 [`桌面端技术架构与功能手册.md`](桌面端技术架构与功能手册.md)。
...
`docs/桌面端技术架构与功能手册.md` 头部的聚合计数（端点数、表数、视图数）历史上多次手工累加，
存在自相矛盾。本文与 `README.md` 中的数字为 **2026-08-26 全量脚本审计值**
（34 模块 / 216 端点 / 24 表 / 36 路由），后续应以脚本审计为准，避免手工维护。
