<template>
  ...
  >
    ...
    <template v-else-if="name === 'bookmark-check'">
      <path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" />
    ...
    <template v-else-if="name === 'book-marked'">
      <path d="M10 4v4" />
      <path d="M2 8v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8" />
      <path d="M4 4h12a2 2 0 0 1 2 2v16" />
      <path d="m9 10 3-1 3 1V4H9z" />
    </template>
    ...
    <template v-else-if="name === 'bar-chart-2'">
    ...
    <template v-else-if="name === 'folder-tree'">
      <path d="M20 10a1 1 0 0 0-1-1h-5l-2-2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1Z" />
      <path d="M21 14a1 1 0 0 0-1-1h-4" />
      <path d="M14 10v6l-3-3Z" />
    </template>

    <template v-else-if="name === 'file-question'">
      <path d="M12 17h.01" />
      <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z" />
    ...
    <template v-else-if="name === 'gamepad-2'">
      <line x1="6" y1="11" x2="10" y2="11" />
      <line x1="8" y1="9" x2="8" y2="13" />
      <line x1="15" y1="12" x2="15.01" y2="12" />
      <line x1="18" y1="10" x2="18.01" y2="10" />
      <path d="M17.32 5H6.68a4 4 0 0 0-3.97 3.59c-.04.32-.07.65-.07.98v10.88c0 .33.03.66.07.98A4 4 0 0 0 6.67 21h10.65a4 4 0 0 0 3.97-3.59c.04-.32.07-.65.07-.98V9.57c0-.33-.03-.66-.07-.98A4 4 0 0 0 17.32 5z" />
    </template>
    ...
    <template v-else-if="name === 'file-up'">
      <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" />
      <path d="M14 2v4a2 2 0 0 0 2 2h4" />
      <path d="M12 12v6" />
    ...
    <template v-else-if="name === 'puzzle'">
      <path d="M19.439 7.85c-.049.322.059.648.289.878l1.568 1.568c.47.47.706 1.087.706 1.704s-.235 1.233-.706 1.704l-1.611 1.611a.98.98 0 0 1-.837.276c-.47-.07-.802-.48-.968-.925a2.501 2.501 0 1 0-3.214 3.214c.446.166.855.497.925.968a.979.979 0 0 1-.276.837l-1.61 1.61a2.404 2.404 0 0 1-1.705.707 2.402 2.402 0 0 1-1.704-.706l-1.568-1.57a.98.98 0 0 0-.877-.29c-.493.074-.84.504-1.02.968a2.5 2.5 0 1 1-3.237-3.237c.464-.18.894-.527.967-1.02a.978.978 0 0 0-.294-.877l-1.57-1.568A2.402 2.402 0 0 1 1.998 12c0-.617.236-1.234.706-1.704L4.23 8.77c.24-.24.581-.353.917-.303.515.077.877.528 1.073 1.01a2.5 2.5 0 1 0 3.259-3.259c-.482-.196-.933-.558-1.01-1.073-.05-.336.062-.676.303-.917l1.525-1.525A2.402 2.402 0 0 1 12 1.998c.617 0 1.234.236 1.704.706l1.568 1.568c.23.23.556.338.877.29.47-.074.802.48.968.925a2.501 2.501 0 1 0 3.214-3.214c-.445-.166-.855-.497-.925-.968a.98.98 0 0 1 .276-.837l1.611-1.611c.94-.94 2.464-.94 3.404 0 .47.47.706 1.087.706 1.704s-.235 1.233-.706 1.704l-1.569 1.568a.98.98 0 0 1-.877.289Z" />
    </template>

    <template v-else-if="name === 'trending-down'">
    ...
    <template v-else-if="name === 'tags'">
      <path d="M11.5 3C6.81 3 3 6.81 3 11.5a8.49 8.49 0 0 0 3.08 6.96l-2.49 4.48A1 1 0 0 0 4 23h7.5c4.69 0 8.5-3.81 8.5-8.5S16.19 3 11.5 3z" />
      <path d="M15 5a5 5 0 0 1 0 10" />
    </template>
    ...
    <template v-else-if="name === 'compass'">
      <circle cx="12" cy="12" r="10" />
      <polygon points="12 2 15 9.5 22 12 15 14.5 12 22 9 14.5 2 12 9 9.5 12 2" />
    </template>

    <template v-else-if="name === 'rocket'">
      <path d="M12 12c-3 0-6-2-6-6s3-6 6-6 6 2 6 6-3 6-6 6z" />
      <path d="M12 12v9" />
